    ...
    public static class EventSeed
    {
        ...
        private static IEnumerable<EventItem> GetPreconfiguredEventItems()
        {
            return new List<EventItem>
           {
                  ...
                  new EventItem() { EventCategoryId=3, EventVenueId=6  , EventStartDateId= 1, EventDescription="Talks on a moment of change from one position to another, whether it be in relationships, beliefs, cultures, perspectives or the world"  , EventName="TEDxSeattle 2019: SHIFT"   , EventCost=20.00m   , EventAddress="321 Mercer St" , EventCity="Seattle"  , EventState="Washington"  , EventZip=98109  , EventFavorite=false , EventTicketsAvailable=100 , EventStartTime="8:00"  ,  EventEndDate="11/23/19", EventEndTime="17:00", EventPictureUrl="http://replace/TedEx_SHIFT_2019.PNG"  , EventUrl="https://tedxseattle.com/" },
                  ...
                  new EventItem() { EventCategoryId=2, EventVenueId=4  , EventStartDateId=1 , EventDescription="Specialty food show connecting local food craftsman with everyday customers."  , EventName="Gobble Up Seattle"   , EventCost=0.00m   , EventAddress="6310 NE 74th St " , EventCity="Seattle"  , EventState="Washington"  , EventZip=98115 , EventFavorite=false, EventTicketsAvailable=200 , EventStartTime="10:00"  ,  EventEndDate="11/23/19",  EventEndTime="17:00"  , EventPictureUrl="http://replace/GobbleUpSeattle.PNG" , EventUrl="https://gobbleupnorthwest.com/" },
                  new EventItem() { EventCategoryId=2, EventVenueId=3  , EventStartDateId=3 , EventDescription="Formal instruction on pairing cheese with Lauren Ashton wine selections."  , EventName="The Art of Cheese"   , EventCost=85.00m   , EventAddress="14545 148th Ave NE, Suite 211" , EventCity="Woodinville"  , EventState="Washington" , EventZip=98072 , EventFavorite=false , EventTicketsAvailable=30 , EventStartTime="18:00" ,  EventEndDate="8/22/19" ,  EventEndTime="20:00"  , EventPictureUrl="http://replace/TheArtofCheese"  , EventUrl="http://laurenashtoncellars.com/calevent/the-art-of-cheese/" },
                  ...
                  new EventItem() { EventCategoryId=2, EventVenueId=1  , EventStartDateId=6 , EventDescription="Live summer concert with Pink Martini and singer China Forbes"  , EventName="An Evening with Pink Martini with singer China Forbes"   , EventCost=79.00m   , EventAddress="14111 NE 145th Street" , EventCity="Woodinville"  , EventState="Washington"  , EventZip=98072  , EventFavorite=false , EventTicketsAvailable=100 , EventStartTime="19:00"  ,  EventEndDate="9/6/19" ,  EventEndTime="21:00"  , EventPictureUrl="PinkMartiniChateauSteMichelle.PNG"  , EventUrl="https://www.ste-michelle.com/visit-us/events-calendar/an-evening-with-pink-martini-with-singer-china-forbes?concert=1" }
